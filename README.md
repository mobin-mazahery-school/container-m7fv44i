...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m7fv44i.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m7fv44i.containers.anotherwebservice.com/
...
```
git clone git@github.com:mobin-mazahery-school/container-m7fv44i.git
cd container-m7fv44i
```
...
```
docker attach container-m7fv44i
```
